...
export const resDetailPage = 
{
    ...
    "items": [
      ...
      },
      {
        "id": 4,
        "img": "url",
        "text": "Esta ventana pertenece al usuario, el cual en este caso tiene tres...",
        "pageId": 1
      },
      {
        "id": 5,
        "img": "url",
        "text": "Esta seria la vista de los servicios. Haciendo click en ella se...",
        "pageId": 1
      },
      {
        "id": 6,
        "img": "url",
        "text": "Aqui tenemos el detalle del servicio, este puede ser de tres tipos:...",
        "pageId": 1
      },
      { "id": 7, "img": 'url', "text": 'Texto de prueba', "pageId": 1 }
...
export const bodyUpdResponse = 
{
    ...
    export const responseItemUpdate =
    {
        "id": 1,
        "img": "url",
        "text": "En este caso este es el campo que actualize en esta ocasion.",
