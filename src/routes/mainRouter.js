...
mainRouter.get("/user/:id", mid.verifyToken, mid.middUuid, ctr.getDetailCtr);
mainRouter.put("/user/:id", mid.verifyToken, mid.middUuid, mid.updHolderMidd, ctr.updUserCtr);
mainRouter.patch("/user/sec/:id", mid.verifyToken, mid.middUuid, ctr.changePassCtr);
mainRouter.delete("/user/:id", mid.verifyToken, mid.middUuid, ctr.delUserCtr);
